...
```bash
image-builder-packager$ sam local start-api
image-builder-packager$ curl http://localhost:3000/
```
...
```bash
aws cloudformation delete-stack --stack-name image-builder-packager
```
